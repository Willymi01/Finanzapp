...
export default function App(){
  ...
  useEffect(()=>{setStateRaw(prev=>saveState(prev))},[state.project,state.assumptions,state.assets,state.budget,state.monthlySavings,state.snapshots,state.properties,state.security])
  ...
  const pages={dashboard:<Dashboard {...props}/>,budget:<Budget {...props}/>,savings:<Savings {...props}/>,assets:<Assets {...props}/>,financing:<Financing {...props}/>,properties:<Properties {...props}/>,cloud:<Cloud cloud={cloud}/>,settings:<Settings {...props} onLockChange={setLocked}/>}
  return <>
